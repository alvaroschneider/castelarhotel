...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        String fechaFormateada = todaysDate.format(formatoFecha);
        ...
        jbSiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                fechaSalida = txtFechaSalida.getDate();
                ...
                System.out.println("fechaFormateada: " + fechaEntradaFormateada);

                Object fpSeleccionado = txtFormaPago.getSelectedItem();
                String fpSeleccionadoString = fpSeleccionado.toString();

                System.out.println("FormaPago: " + fpSeleccionadoString);
                ...
                if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
                    ...
                    try {
                        ...
                        System.out.print("fecha: " + txtFechaEntrada.getDate().toString());
                        String laInsercion = "INSERT INTO reservas(fecha_entrada, fecha_salida, valor, forma_pago) VALUES ('" + fechaEntradaFormateada + "','" + fechaSalidaFormateada + "','" + txtValor.getText() + "','" + fpSeleccionadoString + "')";
        ...
        jbSiguiente.setBounds(238, 493, 122, 35);
