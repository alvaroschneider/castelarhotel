    ...
    public RegistroHuesped(int id) {
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                fechaNacimiento = txtFechaN.getDate();
                String fechaNacimientoFormateada = formatoFecha.format(fechaNacimiento);
                
                Object nacionalidadSeleccionada = txtNacionalidad.getSelectedItem();
                String nacionalidadSeleccionadaString = nacionalidadSeleccionada.toString();
                
                if(RegistroHuesped.txtNombre.getText() != null && RegistroHuesped.txtApellido.getText() != null){
                    // conectamos e insertamos en DB
                    Connection laConexion = null;
                    try {
                        laConexion = ConnectionManager.getConnection();
                        //String laInsercion = "INSERT INTO huespedes(nombre, apellido, fecha_nacimiento, nacionalidad, telefono, idReserva) VALUES ('" + txtNombre.getText() + "','" + txtApellido.getText() + "','" + txtFechaN.getDateFormatString() + "','" + txtTelefono.getText() + "','"+txtNreserva.getText()+"')";
                        String laInsercion = "INSERT INTO huespedes(nombre, apellido, fecha_nacimiento, nacionalidad, telefono, idReserva) VALUES ('" + txtNombre.getText() + "','" + txtApellido.getText() + "','" + fechaNacimientoFormateada + "','"+ nacionalidadSeleccionadaString +"','" + txtTelefono.getText() + "','"+txtNreserva.getText()+"')";
                        PreparedStatement ps = null;
                        ps = (PreparedStatement) laConexion.prepareStatement(laInsercion, Statement.RETURN_GENERATED_KEYS);
                        ps.executeUpdate();
